 ...
 *
 * _coder_helperMonoVisualSLAM_info.c
 *
...
/* Include files */
#include "_coder_helperMonoVisualSLAM_info.h"
#include "emlrt.h"
#include "tmwtypes.h"
...
mxArray *emlrtMexFcnProperties(void)
{
  ...
  emlrtSetField(xEntryPoints, 0, "Name",
                emlrtMxCreateString("helperMonoVisualSLAM"));
  ...
  emlrtSetField(xEntryPoints, 0, "TimeStamp",
                emlrtMxCreateDoubleScalar(739323.57570601848));
...
/* End of code generation (_coder_helperMonoVisualSLAM_info.c) */
