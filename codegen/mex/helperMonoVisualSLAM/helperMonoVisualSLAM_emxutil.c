 ...
 *
 * helperMonoVisualSLAM_emxutil.c
 *
...
{
  if (*pEmxArray != (c_emxArray_images_geotrans_inte *)NULL) {
    emlrtFreeMex((*pEmxArray)->size);
    emlrtRemoveHeapReference((emlrtCTX)sp, (void *)pEmxArray);
    emlrtFreeEmxArray(*pEmxArray);
    *pEmxArray = (c_emxArray_images_geotrans_inte *)NULL;
  }
}
...
{
  c_emxArray_images_geotrans_inte *emxArray;
  int32_T i;
  *pEmxArray = (c_emxArray_images_geotrans_inte *)emlrtMallocEmxArray(
      sizeof(c_emxArray_images_geotrans_inte));
  ...
  if (doPush) {
    emlrtPushHeapReferenceStackEmxArray(
        ...
        (void *)&c_emxFree_images_geotrans_inter, NULL, NULL, NULL);
  }
  emxArray = *pEmxArray;
...
{
  c_emxFree_images_geotrans_inter(sp, &pStruct->Data);
}
...
{
  c_emxInit_images_geotrans_inter(sp, &pStruct->Data, srcLocation, false);
}
...
/* End of code generation (helperMonoVisualSLAM_emxutil.c) */
