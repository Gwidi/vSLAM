clear;
close all;
clear testyCodegena_1024;
clear testyCodegena_mex1x24;
clear waitCodegen_mex2x24;
clear testyCodegena_2x24;
...
imds = imageDatastore("./images30/"); % zbior danych/ zdjec
...
for i = 1:numel(imds.Files)
    ...
    %% Algorytm SLAM
    [xyzPoints, camPoses, status] = waitCodegen_mex2x24(I,imageSize, principalPoint,focalLength,radialDistortion,numPoints,numSkipFrames,numLevels,scaleFactor, verbose,trackFeatureRange,loopClosureThreshold,isStop );
