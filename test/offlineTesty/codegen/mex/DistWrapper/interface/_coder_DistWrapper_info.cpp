...
//
// _coder_DistWrapper_info.cpp
//
// Code generation for function 'DistWrapper'
//

// Include files
#include "_coder_DistWrapper_info.h"
#include "emlrt.h"
#include "tmwtypes.h"
...
mxArray *emlrtMexFcnProperties()
{
  ...
  emlrtSetField(xEntryPoints, 0, "Name", emlrtMxCreateString("DistWrapper"));
  ...
  emlrtSetField(xEntryPoints, 0, "TimeStamp",
                emlrtMxCreateDoubleScalar(739399.60625));
...
// End of code generation (_coder_DistWrapper_info.cpp)
